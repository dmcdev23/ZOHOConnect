...
router.route('/syncOrders').get(auth('user'), validate(wordPressValidaation.syncOrders), licenceValidator,wordPressController.syncOrders);

router.route('/syncProduct').get(auth('user'), validate(wordPressValidaation.syncOrders), licenceValidator,wordPressController.syncProduct);
